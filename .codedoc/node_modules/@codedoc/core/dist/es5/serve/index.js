...
function serve(root, config, builder, themeInstaller, webpackConfig) {
    ...
    var wpconf = webpack_merge_1.merge({ mode: 'development' }, webpackConfig || {});
    ...
    app.use(config.dest.namespace, express_1.default.static(config.dest.assets, { dotfiles: 'allow' }));
