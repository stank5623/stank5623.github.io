...
exports.TocStyle = void 0;
var color_1 = __importDefault(require("color"));
var jss_theme_1 = require("@connectv/jss-theme");
exports.TocStyle = jss_theme_1.themedStyle(function (theme) { return ({
    toc: {
        position: 'fixed',
        display: 'flex',
        zIndex: 101,
        ...
        '& a': {
            ...
            '&:hover': {
                ...
                textDecoration: 'none',
                'body.dark &': { background: color_1.default(theme.dark.background).lighten(.02).toString() },
                '@media (prefers-color-scheme: dark)': {
                    'body:not(.dark-mode-animate) &': {
                        background: color_1.default(theme.dark.background).lighten(.02).toString(),
                    },
                },
            },
            '&.current': {
