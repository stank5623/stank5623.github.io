...
exports.Heading = exports.HeadingStyle = void 0;
var jss_theme_1 = require("@connectv/jss-theme");
var misc_1 = require("../misc");
exports.HeadingStyle = jss_theme_1.themedStyle(function (theme) { return ({
    heading: {
        cursor: 'pointer',
        position: 'relative',
    },
...
function Heading(options, renderer, content) {
    var classes = this.theme.classes(exports.HeadingStyle);
    var h$;
    if (options.depth === 1)
    ...
    renderer.render(renderer.create("fragment", null,
        renderer.create("span", { class: classes.anchor, "data-ignore-text": true },
            renderer.create(misc_1.Icon, null, "link")),
        content)).on(h$);
    return h$;
}
